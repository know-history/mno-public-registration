      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="border-4 border-dashed border-gray-200 rounded-lg p-8">
            <h2 className="text-2xl font-bold mb-6 text-black">Available Applications</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="text-lg font-medium mb-3 text-black">Citizenship Application</h3>
                <p className="text-gray-600 mb-4">
                  Apply for Métis Nation of Ontario citizenship
                </p>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="text-lg font-medium mb-3 text-black">Harvesting Rights</h3>
                <p className="text-gray-600 mb-4">
                  Apply for traditional harvesting rights
                </p>
            ...
            {/* Admin/Researcher Only Content */}
            {(userAttributes?.user_role === 'admin' || userAttributes?.user_role === 'researcher') && (
              <div className="mt-8">
                <h2 className="text-xl font-bold mb-4 text-black">Administrative Tools</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                    <h3 className="font-medium text-purple-900 mb-2">View All Applications</h3>
                    <p className="text-sm text-purple-700 mb-3">Review submitted applications</p>
                    <button className="bg-purple-600 text-white px-3 py-1 rounded text-sm hover:bg-purple-700">
                      Access
                    </button>
                  </div>
                  <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                    <h3 className="font-medium text-purple-900 mb-2">Document Library</h3>
                    <p className="text-sm text-purple-700 mb-3">Access uploaded documents</p>
                    <button className="bg-purple-600 text-white px-3 py-1 rounded text-sm hover:bg-purple-700">
                      Browse
                    </button>
                  </div>
